...
plt.xlabel('x')
plt.ylabel('y1')
plt.title('RK3 Component y1 for Test Case 1 (N=400)')
plt.legend()
plt.grid(True)
...
plt.xlabel('x')
plt.ylabel('y2')
plt.title('RK3 Component y2 for Test Case 1 (N=400)')
plt.legend()
plt.grid(True)
...
plt.xlabel('x')
plt.ylabel('y1')
plt.title('DIRK3 Component y1 for Test Case 1 (N=400)')
plt.legend()
plt.grid(True)
...
plt.xlabel('x')
plt.ylabel('y2')
plt.title('DIRK3 Component y2 for Test Case 1 (N=400)')
plt.legend()
plt.grid(True)
